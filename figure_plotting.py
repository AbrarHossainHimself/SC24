...
plot_objective = True
plot_ucb_low_fid = True
plot_ucb_low_fid_plus_bias = True
plot_ucb_high_fid = True
...
if not os.path.exists(directory):
    os.makedirs(directory)  # This will create the directory if it doesn't exist

save_name = os.path.join(directory, 'PenalizedAF.pdf')
fig.savefig(save_name, bbox_inches='tight')